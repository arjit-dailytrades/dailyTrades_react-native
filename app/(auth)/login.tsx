...
export default function LoginScreen() {
  ...
  // Keyboard listeners — scroll card content when keyboard opens/closes
  useEffect(() => {
    ...
    <LinearGradient colors={theme.bgGradient as any} style={styles.container}>
      ...
      >
        {/*
          ...
          outside the input (logo area, card background) dismisses the keyboard.
          accessible={false} ensures inner buttons/checkbox still fire normally.
        */}
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={{ flex: 1 }}>
            {/* Logo section — flex:1 fills remaining space above card */}
            ...
            {/* Bottom card — ScrollView inside so keyboard pushes content up */}
            <View
              style={[
                styles.bottomCard,
                {
            ...
            >
              <ScrollView
                ...
                bounces={false}
                scrollEnabled={false} // disabled until keyboard opens
              ...
              >
                ...
                >
                  <Image
                    ...
                    style={styles.flag}
                  />
                  <Text style={[styles.code, { color: theme.textMain }]}>
                    +91
                  </Text>
                  <TextInput
                ...
                >
                  ...
                  <Text
                    style={[styles.checkboxLabel, { color: theme.textSub }]}
                  >
      ...
      {/* V2 Checkbox Modal — outside KeyboardAvoidingView so it's unaffected */}
      <Modal
...
const styles = StyleSheet.create({
  ...
  // Logo area — takes all space above the card naturally
  topSection: {
    flex: 1,
    alignItems: "center",
  ...
  // Card — no fixed height, content-driven
  bottomCard: {
    width: "100%",
    ...
    shadowRadius: 20,
    elevation: 10,
    // Max height so it never overflows on small screens
